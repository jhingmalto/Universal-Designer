...
@mxmlc -o bin/AmericanUncial.swf -noplay
*/
package fonts 
{
	 ...
	 * @author mykhel
	 */
	public class AmericanUncial extends Sprite 
	{
		/*
		...
		*/
		...
		[Embed(source='AmericanUncial.ttf'
		,fontFamily  ='AmericanUncial'
		...
		public function AmericanUncial() 
		{

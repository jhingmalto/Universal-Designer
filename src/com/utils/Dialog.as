package com.utils {
	...
	public class Dialog {
		...
		background:String		-	Type of background 
									...
									>	"nonenotmodal" -  no background and make the area behind the Dialog prompt focussable
									>	"simple -  simple colour background
									>	"blur" -  blurred background
									"simple" style is used if background is not specified
		
		buttons:Array			-	An array (maximum of 3) containing the Strings of the buttons to be shown in the Dialog prompt
		callBack:Function		-	The function to be called when a button on the Dialog prompt has been clicked - returns the name of the button that was clicked
		colour:int				-	Main colour for the Dialog
		promptAlpha:int			-	Alpha of the Dialog prompt
